...
const Questionss = () => {
  ...
  const faqs = [
    {
      question: "How can I apply for a job at AppDevs?",
      answer:
        "You can apply directly through the 'Apply Now' button on the job listing that matches your skills and interests.",
    },
    {
      question: "What is the hiring process at AppDevs?",
      answer:
        "Our hiring process typically includes application submission, shortlisting, interviews, assignments (if applicable), and onboarding.",
    },
    {
      question: "How long does the hiring process take?",
      answer:
        "The process duration may vary by role but generally takes a few weeks from application to final decision.",
    },
    {
      question: "Will I receive feedback if my application is not selected?",
      answer:
        "While we strive to provide feedback, due to the volume of applications, it may not always be possible.",
    },
    {
      question: "How can I prepare for an interview at AppDevs?",
      answer:
        "Review the job description, learn about our company values, and be ready to discuss your skills and experiences.",
    },
    {
        question: "What should I include in my application?",
        answer:
          "Ensure your application includes an updated resume, cover letter, and any relevant work samples or certifications.",
      },
  ];
