      ...
      <div className="xl:max-w-[1280px] container px-4 mx-auto relative z-20">
        <div className="section_header mb-10">
          <div className="max-w-[850px] mx-auto text-center">
            ...
            <h1 className="sm:text-heading__two mb-3">Build Your Career With AppDevs</h1>
            <span className="w-[75%]">
        ...
        {jobTitles.map((jobTitle, index) => (
          ...
          >
            <div className="lg:w-3/5">
              ...
              <p className='text-[#6b7280] text-[16px]'>We’re looking for a passionate {jobTitle} to join our dynamic team and contribute to building impactful solutions!</p>
              <div className="sm:flex items-center sm:space-y-0 space-y-3 gap-8 pt-4">
                <span className="text-sm  text-[#6b7280] flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 mr-2 text-[#6b7280]">
            ...
            <div className="apply__btn relative flex items-center ml-auto mt-5 lg:mt-0">
              <a className="primary__btn" href={`/join-our-team/${jobTitle.replace(/ /g, '-').toLowerCase()}`}>
                <span className='text-white bg-blue-600 py-2 px-5 rounded-md'>Apply Now
                  </span>
              </a>
            </div>
          </div>
