      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            Achieve Excellence with Reliable Maintenance and Support Services
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-6 lg:leading-8">
            Ensure uninterrupted performance with our comprehensive maintenance and support services.
            </p>
...
export default FinTechInnovation7;
