          ...
          <div className="relative rounded-[30px] overflow-hidden z-10 xl:py-20 py-14 px-14 bg-[linear-gradient(90deg,#061A46_0%,#153885_100%)]">
            ...
            <div className="mb-8 lg:mb-10 grid grid-cols-12">
              <div className="text-center col-span-12 lg:col-span-8 lg:col-start-3">
                <h2 className="text-white font-semibold max-w-3xl text-5xl mb-4">Steps to Start a Crowdfunding Solution Business</h2>
                <p className="text-white lg:w-[80%] max-w-3xl mx-auto">
                Launching a crowdfunding solution involves several key steps to ensure smooth implementation and adoption.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5">
              ...
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Understand the Market and Legal Framework</h4>
              ...
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Choose a Crowdfunding Model</h4>
                <div className="arrow arrow-right"></div>
              </div>
              {/* Step 3 */}
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Select a Technology Partner</h4>
                <div className="arrow arrow-right"></div>
              </div>
              {/* Step 4 */}
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Design and Develop the Platform</h4>
                <div className="arrow arrow-right"></div>
              </div>
              <div className="text-center relative">
                <div className="w-12 h-12 flex justify-center items-center rounded-full text-2xl font-bold bg-[#DBEAFE] mx-auto mb-4">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Integrate Payment Gateways</h4>
                <div className="arrow arrow-right"></div>
              </div>
              <div className="text-center relative">
                <div className="w-12 h-12 flex justify-center items-center rounded-full text-2xl font-bold bg-[#DBEAFE] mx-auto mb-4">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Market the Platform</h4>
