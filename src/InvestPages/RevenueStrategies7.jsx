...
const profitMethods = [
  {
    ...
    description: "Offer subscription plans for clients to access advanced tools and features.",
    imgSrc: transactionFees,
  },
  {
    title: "Advisory Services",
    description: "Monetize by providing expert financial advice integrated with the solution.",
    imgSrc: subscriptionPlans,
  },
  {
    title: "Transaction Fees",
    description: "Charge small fees for each transaction processed through the platform.",
    imgSrc: merchantPartnerships,
  },
  {
    title: "Third-Party Partnerships",
    description: "Collaborate with fund managers and financial institutions for shared revenues.",
        ...
        <div className="bg-[#EBF2FD] md:py-[40px] py-8 md:px-[30px] px-5 md:rounded-[50px] rounded-3xl">
          <div className="section_header mb-12">
            <div className="max-w-[900px] mx-auto text-center">
              ...
              How Can Bank Owners Generate Profit from an <span className="text-[#7c3aed] inline">Investment Management Solution?</span>
              </h2>
            </div>
          </div>
