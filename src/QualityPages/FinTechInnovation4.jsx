      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            Deliver Perfection with Comprehensive Software Testing Services
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-6 lg:leading-8">
            Guarantee the reliability and performance of your software with expert QA solutions.
            </p>
...
export default FinTechInnovation4;
