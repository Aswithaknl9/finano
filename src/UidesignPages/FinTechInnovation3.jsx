      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            Redefine User Experiences with Expert UI/UX and SaaS Design
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-6 lg:leading-8">
            Create visually appealing and user-friendly designs that captivate your audience.
            </p>
...
export default FinTechInnovation3;
