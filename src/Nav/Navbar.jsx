        ...
        <div className='top-0 left-0 w-full h-[10vh] flex justify-between items-center lg:py-5 px-10 py-20 bg-white bg-opacity-80'>
            ...
            <div className='hidden lg:flex-1 lg:flex justify-center'>
                <ul className='flex gap-8 text-[16px] text-black'>
                    ...
                    <li><NavLink to="/solutions" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-black'}>Solutions</NavLink></li>
                    <li><NavLink to="/services" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-black'}>Services</NavLink></li>
                    ...
                    <li><NavLink to="/company" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-black'}>Company</NavLink></li>
                    <li><NavLink to="/help" className={({ isActive }) => isActive ? 'text-blue-700' : 'text-black'}>Help</NavLink></li>
                </ul>
            </div>
