    ...
    <section className='pt-32 relative'>
      ...
      >
        <div className="text-center max-w-[700px] mx-auto p-8 z-10">
          ...
          Simplify Global Transactions with Innovative Currency Exchange Solutions
          </h1>
          <p className="text-[#6B7280] text-[15px] mb-6">
          Empower your business with a cutting-edge Currency Exchange Solution designed for secure, accurate, and seamless currency conversions. With multi-currency support, real-time rates, and advanced fraud prevention, our solution enables you to expand your services globally and provide exceptional user experiences.
          </p>
      ...
      <section className='pt-14 mx-6 px-4'>
        <div className="max-w-4xl mx-auto text-center p-6">
          <h1 className="text-5xl font-semibold  mb-4 " >Key Features of a <span className='text-[#7C3AED]'>Currency Exchange Solution</span></h1>
          <p className='text-[#6B7280]'>A comprehensive currency exchange platform should cater to both administrative needs for the bank and functional needs for the end users, ensuring a secure and user-friendly experience for all.</p>
        </div>
      ...
      <section className='pt-14 mx-40'>
        <div className=" text-center bg-[#EBF2FD] px-8 py-10 rounded-[50px] p-6">
          <h1 className="text-4xl tex-[48px] font-semibold  mb-2" >How Can Bank Owners Generate Profit from a Cross Border <span className='text-[#7C3AED]'>Currency Exchange Solution?</span></h1>
        <RevenueStrategies4 />
        </div>
      </section>
      <StartBusiness4 />
