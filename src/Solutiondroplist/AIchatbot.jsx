...
import Bankingcard9 from '../AIchatbotPages/Bankingcard9';
import AdminsFeatures8 from '../AIchatbotPages/AdminsFeatures8';
    ...
    <section className='pt-32 relative'>
      ...
      >
        <div className="text-center max-w-[700px] mx-auto p-8 z-10">
          ...
          Revolutionize Customer Engagement with AI Chatbot Solutions
            </h1>

          <p className="text-[#6B7280] text-[15px] mb-6">
          Enhance customer experiences with intelligent AI Chatbot Solutions designed to provide instant, personalized, and round-the-clock support. Automate tasks, resolve queries, and deliver exceptional service, all while optimizing operational efficiency.
          </p>
      ...
      <section className="pt-16 pb-16 mx-6 px-4 ">
        <div className="max-w-4xl mx-auto lg:mb-12 text-center p-6">
          ...
          What Problems Does an AI Chatbot Solution Solve?
          </h1>
        </div>
        <Bankingcard9 />
      </section>
      <section className='pt-14 mx-6 px-4'>
        <div className="max-w-4xl mx-auto text-center p-6">
          <h1 className="text-5xl font-semibold  mb-4 " >Key Features of an Online <span className='text-[#7C3AED]'>AI Chatbot Solution</span></h1>
          <p className='text-[#6B7280]'>A comprehensive AI chatbot platform should cater to both administrative needs for the bank and functional needs for the end users, ensuring a secure and user-friendly experience for all.</p>
        </div>
