...
import { Productpg } from '../Js/Productpg';
        ...
        <div className="section_header lg:mb-14 mb-8">
          <div className="max-w-[775px] mx-auto text-center">
            <h2 className="mb-4 text-black text-4xl font-semibold">
              ...
              <span className="text-[#7c3aed] inline">Payment Gateway Solutions</span>
            </h2>
            <p className="lg:w-[80%] mx-auto text-[#6b7280]">
              For businesses and entrepreneurs looking to launch a payment gateway solutions platform quickly and efficiently
            </p>
          </div>
        </div>
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-4">
          {Productpg.map((product, index) => (
