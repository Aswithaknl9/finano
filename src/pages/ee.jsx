    ...
    <section className="pt-[130px] pb-[180px]">
      <div className="xl:max-w-[1280px] container mx-auto px-4">
        <div className="section_header mb-14 text-center">
          <h2 className="max-w-[700px] mx-auto xl:text-[48px] lg:text-[38px] md:text-[28px] text-[24px] font-semibold">
        ...
        <div className="testimonial_item_wrapper grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayedTestimonials.map((testimonial, index) => (
            <div
              key={index}
              className="testimonial_item bg-white sm:py-9 py-4 sm:px-7 px-4 sm:rounded-[40px] rounded-3xl shadow-lg transition-all duration-700 ease-in-out"
            >
              ...
              <div className="flex items-center">
                <div className="rounded-full overflow-hidden w-12 h-12">
                  <img alt="User" loading="lazy" width="43" height="43" decoding="async" className="object-cover w-full h-full" src={testimonial.userImage} />
                </div>
                <div className="ms-4">
