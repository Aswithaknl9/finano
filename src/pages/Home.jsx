  ...
  return (
    <div>
      <div
        ...
        style={{ backgroundImage: "url('https://appdevs.net/_next/static/media/bannerBg.787073cc.webp')" }}
      >
        <div>
          <div className="text-center max-w-2xl p-8 relative z-10 bg-opacity-75 rounded-lg">
            <span className="text-lg text-[#0E7490] bg-[#0E74901A] font-medium mb-4 rounded-lg text-[18px] px-3 py-1">
