  ...
  return (
    <section className="pb-[130px]">
      <div className="xl:max-w-[1280px] container mx-auto px-4">
        ...
        <div className="absolute top-[4%] left-[20%] animate-zoom-in-out">
          ...
          <div className="absolute top-[4%] right-[20%] animate-zoom-in-out">
          ...
          <div className="absolute top-[33%] left-[-1.5%] animate-zoom-in-out">
          ...
          <div className="absolute top-[33%] right-[-1.5%] animate-zoom-in-out">
          ...
          <div className="lg:w-[400px] md:w-[250px] w-[100px] lg:h-[400px] md:h-[250px] h-[100px] rounded-full border-[1px] border-solid border-[#bed0f9] flex items-center justify-center relative">
            <div className="absolute top-[10%] left-[6%] animate-zoom-in-out">
            ...
            <div className="absolute top-[10%] right-[6%] animate-zoom-in-out">
