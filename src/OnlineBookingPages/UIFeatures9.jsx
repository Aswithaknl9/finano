        ...
        <ul className="space-y-4">
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Service Selection</h5>
            </div>
            <p className="text-[#6B7280] text-[14px] ">Let customers choose services such as medical consultations, salon treatments, or car types.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Real-Time Availability</h5>
            </div>
            <p className="text-[#6B7280] text-[14px]">Display available slots for appointments, staff, or vehicles instantly.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Online Payments</h5>
            </div>
            <p className="text-[#6B7280] text-[14px] ">Enable secure payment options, including pre-payment for bookings.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Booking Modifications</h5>
            </div>
            <p className="text-[#6B7280] text-[14px] ">Allow customers to reschedule or cancel bookings with ease..</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
            ...
            <p className="text-[#6B7280] text-[14px] ">Cater to a global customer base with localized features.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
            ...
            <p className="text-[#6B7280] text-[14px]">Gather customer feedback post-appointment for quality improvements.</p>
          </li>
        </ul>
      </div>
    </div>
