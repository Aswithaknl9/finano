          ...
          <div className="relative rounded-[30px] overflow-hidden z-10 xl:py-20 py-14 px-14 bg-[linear-gradient(90deg,#061A46_0%,#153885_100%)]">
            ...
            <div className="mb-8 lg:mb-10 grid grid-cols-12">
              <div className="text-center col-span-12 lg:col-span-8 lg:col-start-3">
                <h2 className="text-white font-semibold max-w-3xl text-5xl mb-4">Steps to Start an Appointment and Booking Solution Business</h2>
                <p className="text-white lg:w-[80%] max-w-3xl mx-auto">
                Launching a online booking solution involves several key steps to ensure smooth implementation and adoption.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-5">
              ...
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Design the Solution</h4>
                <div className="arrow arrow-right"></div>
              </div>
              {/* Step 3 */}
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Develop the Platform</h4>
                <div className="arrow arrow-right"></div>
              </div>
              {/* Step 4 */}
              <div className="text-center relative">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Test the System</h4>
                <div className="arrow arrow-right"></div>
              </div>
              <div className="text-center relative">
                <div className="w-12 h-12 flex justify-center items-center rounded-full text-2xl font-bold bg-[#DBEAFE] mx-auto mb-4">
                ...
                <h4 className="text-white text-[15px] mb-2.5">Launch the Service</h4>
                <div className="arrow arrow-right"></div>
              </div>
              <div className="text-center relative">
                <div className="w-12 h-12 flex justify-center items-center rounded-full text-2xl font-bold bg-[#DBEAFE] mx-auto mb-4">
...
export default StartBusiness10;
