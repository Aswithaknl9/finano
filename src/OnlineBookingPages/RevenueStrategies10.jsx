...
const RevenueStrategies10 = () => {
  const strategies = [
    {
      imgSrc: 'https://appdevs.net/_next/static/media/streamlinedOperations.873e8c0b.png',
      imgWidth: 25,
      imgHeight: 24,
      title: 'Premium Booking Slots',
      description:
        'Offer early or priority booking options at a higher rate.',
    },
    {
      ...
      description:
        'Introduce subscriptions for repeat customers with exclusive benefits.',
    },
    {
      ...
      description:
        'Charge service providers (doctors, salon staff, car owners) a fee per booking.',
    },
    {
      ...
      description:
        'Provide bundle discounts for multiple services to increase bookings.',
    },
  ];
...
export default RevenueStrategies10;
