      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            Elevate Your Operations with Professional Cloud Services
            </h2>
            <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-6 lg:leading-8">
            Embrace the power of the cloud to optimize your infrastructure, boost scalability, and enhance performance.
            </p>
...
export default FinTechInnovation5;
