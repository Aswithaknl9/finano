        ...
        <div className="container mx-auto">
          <div className="relative rounded-[30px] overflow-hidden z-10 py-10 sm:py-14 lg:py-20 px-6 sm:px-10 lg:px-14 bg-[linear-gradient(90deg,#061A46_0%,#153885_100%)]">
            ...
            <div className="mb-8 lg:mb-10 text-center">
              ...
              We follow a systematic approach to cloud service that aligns with your business goals.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-6">
              ...
              <div className="text-center">
                ...
                <h4 className="text-white text-sm sm:text-base mb-2">Assessment & Strategy</h4>
              </div>
              {/* Step 2 */}
              <div className="text-center">
                <div className="w-12 h-12 flex justify-center items-center rounded-full bg-[#DBEAFE] mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <h4 className="text-white text-sm sm:text-base mb-2">Infrastructure Optimization</h4>
              </div>
              {/* Step 4 */}
              <div className="text-center">
                <div className="w-12 h-12 flex justify-center items-center rounded-full bg-[#DBEAFE] mx-auto mb-4">
                ...
                <h4 className="text-white text-sm sm:text-base mb-2">Application Modernization</h4>
              </div>
              {/* Step 5 */}
              <div className="text-center">
                <div className="w-12 h-12 flex justify-center items-center rounded-full bg-[#DBEAFE] mx-auto mb-4">
                ...
                <h4 className="text-white text-sm sm:text-base mb-2">Security & Compliance</h4>
              </div>
              {/* Step 6 */}
              <div className="text-center">
                <div className="w-12 h-12 flex justify-center items-center rounded-full bg-[#DBEAFE] mx-auto mb-4">
...
export default Startbusiness115;
