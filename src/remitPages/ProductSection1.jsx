...
import { Productrs } from '../Js/Productrs';
        ...
        <div className="section_header lg:mb-14 mb-8">
          <div className="max-w-[775px] mx-auto text-center">
            <h2 className="mb-4 text-black text-4xl font-semibold">
              ...
              <span className="text-[#7c3aed] inline">Remittance Solutions</span>
            </h2>
              ...
              <div className="lg:p-6 md:p-4 p-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center mt-4">
                    <span className="lg:text-heading__four text-heading__six font-semibold text-blue-600">{productrs.price}</span>
                  </div>
                  <div className="flex items-center mt-4 space-x-2">
                    <a
                      href={productrs.cartLink}
                      target="_blank"
                      rel="noopener noreferrer"
                    ...
                    <a
                      href={productrs.livePreviewLink}
                      target="_blank"
                      rel="noopener noreferrer"
