        ...
        <ul className="space-y-4">
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Easy Transaction Setup</h5>
            </div>
            <p className="text-[#6B7280] text-[14px] ">Allow buyers and sellers to initiate and customize transactions effortlessly.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Secure Fund Management</h5>
            </div>
            <p className="text-[#6B7280] text-[14px]">Hold and release funds securely as per agreed terms.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Real-Time Updates</h5>
            </div>
            <p className="text-[#6B7280] text-[14px] ">Notify users about the status of their transactions via email or SMS.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Integrated Payment Options</h5>
            </div>
            <p className="text-[#6B7280] text-[14px] ">Support multiple payment methods like credit cards, bank transfers, and digital wallets.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
            ...
            <p className="text-[#6B7280] text-[14px] ">Enable transactions in multiple currencies for international trade.</p>
          </li>
          <li className="bg-white rounded-[20px] shadow-lg bg-white__color p-5">
            <div className="flex items-center mb-3">
              <div className="w-[36px] h-[36px] flex items-center justify-center bg-white shadow-lg rounded-full">
              ...
              <h5 className="ms-2 font-semibold text-[18px]">Mobile and Web Accessibility</h5>
            </div>
            <p className="text-[#6B7280] text-[14px]">Ensure users can manage their escrow transactions from any device.</p>
          </li>
        </ul>
      </div>
    </div>
