            ...
            <div className="footer-logo-and-info space-y-6">
              <div className="footer-logo">
                <a href="https://demo.casethemes.net/finano">
                  <img
                    src="https://demo.casethemes.net/finano/wp-content/uploads/2019/01/h4-logo-footer-1.png"
                    alt="Footer Logo"
                    className="h-14"
                  />
                </a>
              ...
              <div className="contact-info">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center">
                    <i className="fa fa-phone mr-3 text-white"></i>+123 (4567) 890
                  </li>
                  <li className="flex items-center">
                    <i className="fa fa-envelope mr-3 text-white"></i>info@financ.com
                  </li>
                  <li className="flex items-center">
                    <i className="fa fa-home mr-3 text-white"></i>380 St Kilda Road, Melbourne VIC 3004, Australia
                  </li>
                </ul>
              </div>
            </div>
