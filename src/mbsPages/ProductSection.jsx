...
import { Productmbs } from '../Js/Productmbs';
      ...
      <div className="xl:max-w-[1280px] container mx-auto px-4">
        <div className="section_header lg:mb-14 mb-8">
          <div className="max-w-[775px] mx-auto text-center">
            <h2 className="mb-4 text-black text-5xl font-semibold">
              Our Ready-Made Solutions for 
              <span className="text-[#7c3aed] inline">Mobile Banking</span>
            </h2>
            <p className="lg:w-[80%] mx-auto text-[#6b7280]">
              For businesses and entrepreneurs looking to launch a mobile banking platform quickly and efficiently
            </p>
          </div>
        </div>
        <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-4">
          {Productmbs.map((product, index) => (
            <div key={index} className="product_item bg-white shadow-lg rounded-[20px] overflow-hidden">
              ...
              <div className="lg:p-6 md:p-4 p-3">
                <div className="space-x-2 md:mb-4 mb-3">
                  <span className="md:text-[12px] text-[10px] leading-none font-medium md:py-[6px] py-1 md:px-3 px-2 rounded-full" 
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center mt-4 space-x-2">
                    <a href={product.cartLink} target="_blank" rel="noopener noreferrer" 
